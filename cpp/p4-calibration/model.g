...
frame volumeL { shape:ssBox size:[.4 .4 .4 .01] color:[.5 0 0 .2] X:<t(-.2 .85 1.05) d(0 1 0 0)>, noVisual }
frame volumeR { shape:ssBox size:[.4 .4 .4 .01] color:[.5 0 0 .2] X:<t( .2 .85 1.05) d(0 1 0 0)>, noVisual }
