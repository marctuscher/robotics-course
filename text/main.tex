...
Such objectives can either be equality constraints $h$, e.g. the distance between to frames, inequality constraints $g$ or costs terms which contribute to $f$.
...
For further improvements we test the path planning feature of the KOMO library which allows to calculate complete trajectories.
\clearpage
\section{Milestones}
...
23.05.19 & set up bounding box detector for object localization & transform output pose of \textit{GQCNN} into cartesian coordinates\\[5pt]
