...
Robust grasping of unknown objects is a problem at the heart of many tasks in the field of robotics. Our main goal 
is to setup a framework which extracts robust grasp poses from RGBD-Images. 
